...
$phpend_api_endpoints = [
	...
	'GET' => [
		...
		// requests that an account activation email be sent to a registered user's email...
		'/user/{email}/status'						=> ['phpend_api_request_verify',		['access' => 0]],

		// requests that an password reset email be sent to a registered user's email...
